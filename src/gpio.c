 ...
 */
void 
gpio_output_conf(uint32_t set_mask, uint32_t clear_mask, uint32_t enable_mask, uint32_t disable_mask)
{
...
*/
void 
gpio_pin_wakeup_enable(uint32_t i, GPIO_INT_TYPE intr_state)
{
    uint32_t pin_reg;
...
void 
gpio_pin_intr_state_set(uint32_t i, GPIO_INT_TYPE intr_state)
{
    uint32_t pin_reg;
